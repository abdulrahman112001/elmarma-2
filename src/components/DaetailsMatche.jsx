...
function DaetailsMatche() {
  ...
  console.log("🚀 ~ file: DaetailsMatche.jsx:29 ~ DaetailsMatche ~ DetailsMathch:", DetailsMathch)
  ...
  console.log("🚀 ~ file: DaetailsMatche.jsx:43 ~ DaetailsMatche ~ MathchGroub:", MathchGroub)
  ...
  console.log("🚀 ~ file: DaetailsMatche.jsx:58 ~ DaetailsMatche ~ MathchGroubPost:", MathchGroubPost)
    ...
    <div style={{marginTop:"120px"}}>
      <Row className="p-4">
        <div className="col-md-8">
          <>
            {!!isLoading &&
            featchingMatchDetailsVideo &&
            featchingMatchDetailsPost ? (
