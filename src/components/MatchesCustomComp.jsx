  ...
  return (
    <div>
      {MatchesCards.map((match) => (
        <>
          <div style={{backgroundColor:'#333333 !important'}} className=" shadow text-dark p-1 rounded-3 mt-2">
            <div className="d-flex justify-content-between align-items-center ">
              <div className="d-flex flex-column justify-content-center align-items-center">
                <img src={match?.first_image} alt="" width={"30px"} />
                {/* <p className=" fw-bold p-0 m-0 text-white" style={{ fontSize: "10px" }}>
                  {match?.first_team}
                </p> */}
              </div>
              ...
              <div className="d-flex flex-column justify-content-center align-items-center">
                <img
                  ...
                  width={"30px"}
                />
                {/* <p className="fw-bold p-0 m-0 text-white" style={{ fontSize: "10px" }}>{match?.second_team}</p> */}
              </div>
            </div>
          </div>
        </>
...
export default MatchesCustomComp;
