...
function ProbabiltyMatches() {
  ...
  const { data: stastics, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const res = await apiClient.get(`statistics-leagues-tournaments/${idLoca}`);
  ...
  console.log(
    "🚀 ~ file: ProbabiltyMatches.jsx:17 ~ ProbabiltyMatches ~ stasticsData:",
    stasticsData
  );
  ...
  return (
    <>
        ...
        ) : stasticsData.length == 0  ? `${t('sorry data not found')}` : 
        <>
      <div
          ...
          <Row>
            <Col sm={12} xl={5} className="bg-white m-3 p-1 rounded-3">
              <div className="d-flex align-items-center justify-content-between ">
                ...
                <h1 style={{ color: "#0573F6" }}>{probabilty.count_matches}</h1>
              </div>
            </Col>
            <Col sm={12} xl={5} className="bg-white m-3 p-1 rounded-3">
              <div className="d-flex align-items-center justify-content-between ">
                ...
                <h1 style={{ color: "#0573F6" }}>{probabilty.goals_scored}</h1>
              </div>
            </Col>
            <Col sm={12} xl={5} className="bg-white m-3 p-1 rounded-3">
            <div className="d-flex align-items-center justify-content-between ">
